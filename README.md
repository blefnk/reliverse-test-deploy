...
- **🚀 Live Demo**: [reliverse-test-deploy.vercel.app](https://reliverse-test-deploy.vercel.app/en)
- **💙 Discord**: [discord.gg/Pb8uKbwpsJ](https://discord.gg/Pb8uKbwpsJ)
- **📚 Docs**: [docs.reliverse.org](https://docs.reliverse.org/reliverse-test-deploy)
...
1. `git clone https://github.com/blefnk/reliverse-test-deploy.git`
2. `cd reliverse-test-deploy`
3. `bun i`
